    ...
    function createComponents(app)
        ...
        % Check if there is a currently detected disease
            ...
            % Display the options in a message box
                if ~isempty(options)
                    options1 = ['English Options:' newline optionsEnglish newline ...
                        'Romanian Options:' newline optionsRomanian];
                    uialert(app.DiseaseDetectionUIFigure, options1, 'Treatment Options', 'Icon', 'info');
                else
