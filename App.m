classdef App < matlab.apps.AppBase
    ...
    % Create UIFigure and components
        function createComponents(app)
            ...
            app.DiseaseDetectionUIFigure = uifigure('Name', 'MATLAB Application for Plant Disease Detection Using Deep Learning');
     ...
     % Only update the Tool Tip message if there is a valid disease detected
         ...
         function ContactInfo(app)
            contactInfo = struct(...
                ...
                "   ", ...
                "➡️Website: <a href='https://www.anfdf.ro/'>https://www.anfdf.ro/</a>", ...
                "➡️Email: <a href='mailto:fitosanitar@anfdf.ro'>fitosanitar@anfdf.ro</a> / <a href='mailto:lccf@lccf.ro'>lccf@lccf.ro</a>", ...
            ...
            if strcmp(selectedLanguage, 'ENG')
                uialert(app.DiseaseDetectionUIFigure, message, 'Contact Information', 'Icon', 'info', 'Interpreter', 'html');
            elseif strcmp(selectedLanguage, 'RO')
                uialert(app.DiseaseDetectionUIFigure, message, 'Informații de Contact', 'Icon', 'info', 'Interpreter', 'html');
            end
         ...
         function details = getDiseaseDetails(app, disease)
            ...
            values_Ro = {struct('Romanian',['Pătarea bacteriană a ardeiului:'...
            ...
            struct('Romanian',['Pătarea cafenie a frunzelor de tomate:'...
            ...
            struct('Romanian',['Septorioza tomatelor:'...
            ...
            struct('Romanian',['Păianjenul roșu comun al tomatelor:'...
            ...
            struct('Romanian',['Pătarea frunzelor:'...
            ...
            struct('Romanian',['Virusul încrețirii galbene a frunzelor de tomată):'...
